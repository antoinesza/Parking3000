...
<header>
    <div class="container p-0">
        <nav class="navbar navbar-light">
            <a class="navbar-brand mr-auto" href="index.html"> <img src="../img/logo/logo.png" height="120" alt="Parkingsdeparis"> <span class="sr-only">Parkingsdeparis</span> </a>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10 text-center intro-box">
            ...
            <h4>Plus de 500.000 conducteurs ont déjà réservé sur Parking 3000</h4>
        ...
        <div class="row no-gutters">
            <div class="col-12 col-lg-6 text-center text-sm-left">
                <p class="h1"> <span class="d-block">
                    ...
                    </span> <a  onclick="reserveButton()" class="btn btn-primary text-uppercase">Réserver</a> </p>
            </div>
    ...
    <div class="container">
        <div class="row no-gutters align-items-center">
            <div class="col-12 col-md-7 text-center text-md-left">
                ...
                <p class="h3 light text-secondary">Téléchargez notre appli Parking 3000</p>
                <ul class="list-inline">
                    <li class="list-inline-item mr-0 mr-md-3">
                        <a  class="d-block"> <img src="../static.parkingsdeparis.com/assets/img/apps/badges/ios_badge_FR.png" alt=""> </a>
                    </li>
                    <li class="list-inline-item mt-3 mt-md-0">
                        <a  class="d-block"> <img src="../static.parkingsdeparis.com/assets/img/apps/badges/android_badge_FR.png" alt=""> </a>
                    </li>
                </ul>
            </div>
